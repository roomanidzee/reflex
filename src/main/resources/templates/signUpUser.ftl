...
<div class="signup-box">
    <div class="card">
        <div class="body">
            <form id="sign_up" action="/signUpUser" method="POST" novalidate="novalidate">
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <input type="text" class="form-control" name="key" placeholder="Ваш ключ регистрации" value="${userRegistrationForm.key!}" required="" aria-required="true">
                    </div>
                </div>
